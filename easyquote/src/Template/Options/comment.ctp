			...
			<table class="table">
				...
				<?php  foreach ($services as $service): ?>
					<tr>
						...
						<?php if(isset($workingHours)){ foreach ($workingHours as $workingHour){ ?>
						<td><?php if($workingHour->service_id == h($service->id)){ echo "1"; }else { echo "0"; } ?></td><?php }} else { ?><td><?php echo "0"; }?></td>
						<td class="actions">
							...
							<a class="tooltips" data-original-title="Edit" data-toggle="tooltip " data-placement="bottom" title="" href="<?php echo BASE_PATH."Services/addservicehour/".$service->id?>">
