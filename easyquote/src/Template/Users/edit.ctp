		...
		<div class="panel-body">
			<?php echo $this->Form->create($user,['label'=>false,'class'=>"form-horizontal",'role'=>"form",'type' => 'file']); ?>
				...
				<div class="form-group ">
					...
					<div class="col-lg-6">
						<div class="input-group m-bot15">
							...
							<?php
								echo $this->Form->input('name',['label'=>false,'class'=>"form-control",'placeholder'=>""]);
							?>
						</div>
					</div>
				</div>
				<div class="form-group ">
					...
					<div class="col-lg-6">
						<div class="input-group m-bot15">
							...
							<?php
							echo $this->Form->input('username',['label'=>false,'class'=>"form-control",'placeholder'=>""]);
							?>
						</div>
					</div>
				</div>
				<div class="form-group ">
					...
					<div class="col-lg-6">
						<div class="input-group m-bot15">
							...
							<?php
								echo $this->Form->input('password',['label'=>false,'class'=>"form-control",'placeholder'=>""]);
							?>
						</div>
					</div>
				</div>
				<div class="form-group ">
					...
					<div class="col-lg-6">
						<div class="input-group m-bot15">
							...
							<?php
								echo $this->Form->input('company',['label'=>false,'class'=>"form-control",'placeholder'=>""]);
							?>
						</div>
					</div>
				</div>
				<!--<div class="form-group ">
					...
					<div class="col-lg-6">
						<?php
							echo $this->Form->input('logo',['label'=>false,'type' => 'file']);
						?>
					</div>
				</div>-->
				...
				<input type="hidden" id="immmg" name="logo" value="<?php echo $user['logo'];?>"/>
					...
					<div class="form-group">
						...
						<div  class="col-lg-6 cropHeaderWrapper">
							<div id="croppic">
							<img src="<?php echo BASE_PATH.$user['logo'];?>" alt="client" id="ImageShow">
							</div>
				...
				<div class="form-group ">
					...
					<div class="col-lg-6">
						<div class="input-group m-bot15">
							...
							<?php
								echo $this->Form->input('website',['label'=>false,'class'=>"form-control",'placeholder'=>""]);
							?>
						</div>
					</div>
				</div>
				<div class="form-group ">
					...
					<div class="col-lg-6">
						<div class="input-group m-bot15">
							...
							<?php
								echo $this->Form->input('address',['label'=>false,'class'=>"form-control",'placeholder'=>""]);
							?>
						</div>
					</div>
				</div>
				<div class="form-group ">
					...
					<div class="col-lg-6">
						<div class="input-group m-bot15">
							...
							<?php
								echo $this->Form->input('phone',['label'=>false,'class'=>"form-control",'placeholder'=>""]);
							?>
						</div>
					</div>
				</div>
				<div class="form-group ">
					...
					<div class="col-lg-6">
						<div class="input-group m-bot15">
							...
							<?php
								echo $this->Form->input('info',['label'=>false,'class'=>"form-control",'placeholder'=>""]);
							?>
						</div>
					</div>
				</div>
				<div class="form-group ">
					...
					<div class="col-lg-6">
						<div class="input-group m-bot15">
							...
							<?php
								echo $this->Form->input('type',['label'=>false,'class'=>"form-control",'placeholder'=>""]);
							?>
						</div>
					</div>
				</div>
