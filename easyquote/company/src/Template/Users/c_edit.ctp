			...
			<?php echo $this->Form->create($user,['label'=>false,'class'=>"form-horizontal",'role'=>"form",'type' => 'file']); ?>
				...
				<div class="form-group ">
					...
					<div class="col-lg-6">
						<div class="input-group m-bot15">
							...
							<?php echo $this->Form->input('password',['label'=>false,'class'=>"form-control",'placeholder'=>"Enter New password if you want to change it.",'autocomplete'=>'off','value'=>'']); ?>
						</div>
					</div>
				</div>
				<div class="form-group ">
				...
				<div class="form-group">
                    <div class="col-lg-offset-3 col-lg-6">
						<?php echo $this->Form->button('Submit',['label'=>false, 'onclick'=>"getImage()", 'class'=>"btn btn-primary", 'type'=>"submit"]) ?>
					</div>
                </div>
