		...
		bindImgUploadControl: function(){
			...
			that.form.find('input[type="file"]').change(function(){
				...
				$.ajax({
					...
					if(response.height < 220){
							alert('Your Image is too Short to Crop!! Please Use Image with Size higher than 250x250');
			...
			$.ajax({
                ...
                type: 'POST'
					...
					if(response.status=='success'){
						...
						that.obj.append('<img id="croppic11" class="croppedImg '+response.url+'" src="'+response.base+response.url+'">');
