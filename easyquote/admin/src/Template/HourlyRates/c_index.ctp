<div class="col-lg-12">
	<section class="panel">
		<header class="panel-heading">
			Hourly Rates
			<a class="btn btn-primary btn-sm user" style="margin-right:16px;float:right;margin-top:-12px;" href="<?php echo BASE_PATH;?>HourlyRates/c_add">
				...
				?>
					<tr>
						...
						<td class="actions">
							...
							<a class="tooltips" data-original-title="Edit" data-toggle="tooltip " data-placement="bottom" title="" href="<?php echo BASE_PATH."HourlyRates/c_edit/".$hourlyRate->id?>">
								<i class="fa fa-edit fa-lg"></i>
							</a>
							
							
							<a class="tooltips" data-original-title="Delete" data-toggle="tooltip " data-placement="bottom"    href="<?php echo BASE_PATH."HourlyRates/c_delete/".$hourlyRate->id; ?>">
