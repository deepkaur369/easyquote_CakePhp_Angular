...
<div class="col-lg-12">
	<section class="panel">
		...
		<div class="panel-body">
			...
			<div class="form-group ">
				<label class="col-lg-2 control-label">Email<sup>*</sup></label>
				<div class="col-lg-6">
					<div class="input-group m-bot15">
			...
			<input type="hidden" id="immmg" name="image" value="<?php echo $customer->image;?>"/>
			...
			<div class="form-group">
				...
				<div  class="col-lg-6 cropHeaderWrapper">
					<div id="croppic">
					<img src="<?php echo BASE_PATH."webroot/".$customer->image;?>" alt="client" id="ImageShow">
					</div>
					<span class="fileupload-new btn btn-white" id="cropContainerHeaderButton">Select image</span>
				</div>
			</div>
			<div class="form-group ">
				<label class="col-lg-2 control-label">IP<sup>*</sup></label>
				<div class="col-lg-6">
					<div class="input-group m-bot15">
