...
function confm(id){
	...
	if (r == true) {
		$.ajax({
		url: "<?php echo BASE_PATH ?>WorkingHours/c_delete/" +id,
		type: "POST",
					...
					<tr>
						...
						<td class="actions">
							...
							<?php if($workingHours){ 
								if(empty($serviceid[$service->id])){
								?>
							<a class="tooltips" data-original-title="Add" data-toggle="tooltip " data-placement="bottom" href="<?php echo BASE_PATH."WorkingHours/c_addservicehour/".$service->id?>">
							...
							<a class="tooltips" data-original-title="Edit" data-toggle="tooltip " data-placement="bottom" title="" href="<?php echo BASE_PATH."WorkingHours/c_editservicehour/".$service->id?>">
							...
							<a class="tooltips" data-original-title="Delete" data-toggle="tooltip " data-placement="bottom"   style="cursor:pointer;" onclick="confm(<?php echo $service->id; ?>)" >
								...
								<!--href="<?php echo BASE_PATH."WorkingHours/c_delete/".$service->id; ?>"-->
							</a><?php }} } ?>
						</td>
					</tr>
				<?php } ?>
