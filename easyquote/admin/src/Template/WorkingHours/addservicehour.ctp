...
<div class="col-lg-12">
	<section class="panel">
		...
		<div class="panel-body">
			...
			<?php $i=0; $ques_name="";?>
				<?php  foreach ($question as $questions){ //echo "<pre>";print_r($questions->options);echo "</pre>";?>
				
				<?php $sizeopts=sizeof($questions->options); $dat=0;for($j=0; $j < $sizeopts; $j++){
				if(!empty($sizeopts) && h($questions->options[$j]->is_chargeable) == 1){
				$dat=1;
				}else{
				$dat=0;
				}
