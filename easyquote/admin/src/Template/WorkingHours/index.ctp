...
function confm(id){
	...
	var r = confirm("Do you really wants to delete id#" +id);
...
<div class="col-lg-12">
	<div class="form-group" style="margin:0px;margin-bottom:20px;margin-top:40px;">
		...
		if(empty($working_Hours)){?><a class="btn btn-primary btn-sm user" style="margin-right:16px;float:right;margin-top:-30px;" href="<?php echo BASE_PATH;?>WorkingHours/add">
...
<!-- 		<header class="panel-heading">
		...
		<header class="panel-heading" style="height: 62px;">
			Working Hours
			<a class="btn btn-primary btn-sm user" style="margin-right:16px;float:right;margin-top:-12px;" href="  http://localhost/Cake_php/easyquote/admin/working_hours/add">
					<i class="fa fa-plus" style="font-size:25px"> </i>
					<span class="iHover" style="display:block">New Working hours</span>
				</a>
		</header>
		...
		<div class="panel-body">
			<table class="table">
				...
				<tbody>
					...
					<!-- 		<?= $this->Html->link(__('Add'), ['action' => 'add', $workingHour->service->id]) ?>
							<a class="tooltips" data-original-title="Add" data-toggle="tooltip " data-placement="bottom" href="<?php echo BASE_PATH."working_hours/add/".$workingHour->service->id?>">
								<i class="fa fa-plus-circle"></i>
							</a> -->

							<?= $this->Html->link(__('View'), ['action' => 'view', $workingHour->id]) ?>
							<a class="tooltips" data-original-title="View" data-toggle="tooltip " data-placement="bottom" href="<?php echo BASE_PATH."WorkingHours/view/".$workingHour->id?>">
								<i class="fa fa-eye fa-lg"></i>
							</a>
							
							<?= $this->Html->link(__('Edit'), ['action' => 'edit', $workingHour->id])?>
							<a class="tooltips" data-original-title="Edit" data-toggle="tooltip " data-placement="bottom" title="" href="<?php echo BASE_PATH."WorkingHours/edit/".$workingHour->id?>">
							...
							<a class="tooltips" data-original-title="Delete" data-toggle="tooltip " data-placement="bottom"  style="cursor:pointer;" onclick="confm(<?php echo $workingHour->id; ?>)" >
							<i class="fa fa-trash-o fa-lg" ></i>
							<!--href="<?php echo BASE_PATH."WorkingHours/delete/".$workingHour->id; ?>"-->
							</a>
				...
				<tr>
						...
						<td class="actions">
							...
							<?/*= $this->Form->postLink(__('Delete'), ['action' => 'delete', $workingHour->id], ['confirm' => __('Are you sure you want to delete # {0}?', $workingHour->id)])*/ ?>
							<a class="tooltips" data-original-title="Delete" data-toggle="tooltip " data-placement="bottom"    href="<?php echo BASE_PATH."WorkingHours/delete/".$workingHour->id; ?>">
