...
//echo '<pre>';echo $ldiv; echo '</pre>';exit; ?>
...
<!--##################### Stack for Questions #############################-->
			...
			<div style="width:20%!important;float:left!important;">
				...
				<div class="w q" style="left:560px;" ondrag="getPositions(this)"  id="<?php echo $i ?>">
					...
					<div class="ep" style="  color: white; margin-top: 3px;" id="drag<?php echo $i ?>">&nbsp;Start &nbsp;</div>
				</div>
				<?php   
		
				
				
					}else if(!in_array($i,$tempQ)){
...
<!--######################### Stack for Options ##########################-->	
	...
	<!-- ###########################  Dynamic Question object creation  ########################### -->	
		...
		<div class="w q" <?php echo $question->style; ?> ondrag="getPositions(this)" id="<?php echo $i ?>">
				...
				<input type="hidden" id="parent_id_<?php echo $i ?>" value="<?php echo $question->relations[0]->option_id ?>" />
				...
				<!-- Update Button -->
				<span style="color:white;" id="pree<?php echo $i ?>">Q: <?php echo $question->title; ?></span>
			
				<a style="color:white;" href="#question" data-original-title="Question" data-content="<?php echo $question->question; ?>" data-placement="right" data-trigger="hover" class="popovers" style="display:none" id="edit<?php echo $i ?>" onclick="setID(<?php echo $i ?>,'question'),editQuestion(<?php echo $i ?>);" data-toggle="modal" data-target="#question" ></a>
	...
	<!-- ###########################  Dynamic option object creation  ########################### -->				
				<div ondrag="getPositions(this)" <?php echo $option->style; ?>  class="w" id="<?php echo $i ?>">
						...
						<!-- Update Button -->
						<span style="color:black" id="pree<?php echo $i ?>">O: <?php echo $option->title; ?></span>	
						
						<a data-original-title="Option" data-content="<?php echo $option->name; ?>" data-placement="right" data-trigger="hover" class="popovers" style="display:none" id="edit<?php echo $i ?>" href="javascript:getClick(<?php echo $i ?>,'getdata')" > </a>
...
jQuery(
  function($)
  {
	...
	document.getElementById('lastdiv').style.right="30px";
	$("#"+val).animate(
        {"right": "+=10px"});
